...
export function BestSellingProducts({ products }: { products: IBestSellingProduct[] }) {
      ...
      <div className="flex gap-5">
        {products.map((product) => (
          <div key={product.id} className="flex flex-col">
            <img src={product.images[0]} alt={product.title} className="w-[15rem] h-[19.5rem] object-cover"/>
